...
Route::post('/laravia/contents/store', [ContentController::class, 'store'])->name('laravia.content::store')->middleware(['web', 'auth']);
Route::post('/laravia/contents/update', [ContentController::class, 'update'])->name('laravia.content::update')->middleware(['web', 'auth']);
